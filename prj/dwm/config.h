...
static const char dmenufont[]       = "uw ttyp0:pixelsize=18:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ 0, Win|Ctrl,                     XK_s,      spawn,          SHCMD("surf https://google.com") },
	...
	{ 0, Alt|Ctrl,                     XK_space,  resetlayout,    {.i = 1} },
	...
	{ 0, Win,           XF86XK_MonBrightnessUp,   spawn,          SHCMD("~/.bin/brightness bigup") },
	{ 0, Win,           XF86XK_MonBrightnessDown, spawn,          SHCMD("~/.bin/brightness bigdown") },
};
...
{
	/* only set border for non-fullscreen windows (fixes feh border) */
	c->bw = (borderpx + borderpxf * c->isfloating) * (!c->isfullscreen);
	XWindowChanges wc;
